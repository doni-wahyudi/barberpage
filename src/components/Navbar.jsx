    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                ...
                >
                    <img src={`${import.meta.env.BASE_URL}auro_logo.webp?v=3`} alt="Auro Logo" className="h-10 lg:h-14 py-1 object-contain" />
                    {!isAdminView && (
            ...
            <AnimatePresence>
                {mobileMenuOpen && (
                    <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: -20 }}
                        className="lg:hidden absolute top-full left-0 right-0 bg-[#0a0a0a] border-b border-[#d4af37]/20 py-8 px-6 flex flex-col gap-6 items-center"
                    >
                        {isAdminView ? (
                            <button
                                onClick={() => {
